...
- Added bundled-local OCR foundations:
  ...
  - added `scripts/packaging/stage-ocr-runtime.ps1`; installed Tesseract can now be staged as a full local runtime folder, and qpdf plus `eng.traineddata` stage successfully
  - live fallback OCR smoke on the generated scanned `PROJECT_CONTEXT` PDF reached 0.9917 normalized similarity, 0.9976 source-word recall, and 0.9884 source-vocabulary precision
