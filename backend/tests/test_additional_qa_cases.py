...
class AdditionalQACases(unittest.TestCase):
    ...
    def test_onboarding_model_download_flow_exposes_location_progress_and_continue(self) -> None:
        ...
        self.assertIn('"Privacy",', onboarding)
        self.assertIn("<span>Account</span><span className=\"text-muted-foreground\">Not required</span>", onboarding)
        self.assertIn("<span>Cloud sync</span><span className=\"text-muted-foreground\">Off</span>", onboarding)
