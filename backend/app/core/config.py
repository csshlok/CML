...
class Settings(BaseSettings):
    ...
    lora_skip_quality_gate: bool = False
    lora_min_sources: int = 8
    lora_min_unique_sources: int = 8
    lora_min_tokens: int = 6000
    lora_min_validation_records: int = 4
    lora_max_duplicate_ratio: float = 0.25
    lora_benchmark_min_train_records: int = 400
    lora_benchmark_min_validation_records: int = 80
    lora_benchmark_min_validation_records_per_category: int = 10
    lora_benchmark_min_unique_sources: int = 60
    lora_benchmark_min_unique_content_hashes: int = 60
    lora_benchmark_max_train_record_share_per_source: float = 0.10
    lora_benchmark_max_validation_record_share_per_source: float = 0.10
    lora_benchmark_max_validation_record_share_per_source_per_category: float = 0.20
    lora_benchmark_case_limit: int = 0
    lora_train_source_target: int = 0
    lora_validation_source_target: int = 0
    ...
    lora_runtime_repetition_penalty: float = 1.1
    lora_runtime_no_repeat_ngram_size: int = 4
    lora_runtime_batch_timeout_seconds: int = 1800
    lora_runtime_batch_timeout_per_prompt_seconds: int = 15
    ...
    lora_training_num_train_epochs: float = 3.0
