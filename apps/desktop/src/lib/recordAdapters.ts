...
export function sourceFromRecord(record: SourceRecord): Source {
  ...
  return {
    ...
    clusterId: record.cluster_id,
      ...
      ingestionStage: record.ingestion_stage,
      ingestionGeneration: record.ingestion_generation,
      ingestionErrorCode: record.ingestion_error_code ?? undefined,
      ingestionStatusDetail: record.ingestion_status_detail,
      ingestionUpdatedAt: record.ingestion_updated_at ?? undefined,
    createdAt: record.created_at,
    updatedAt: record.updated_at,
    preview: buildRepresentativePreview(extracted, record.summary),
    summary: record.summary,
    tags: record.tags ?? [],
    metadataQuality: record.metadata_quality ?? "fallback",
    semanticMetadataVersion: record.semantic_metadata_version ?? 0,
    semanticMetadataUpdatedAt: record.semantic_metadata_updated_at ?? undefined,
